...
export default defineConfig({
    ...
    head: [
        [
            ...
            {
                rel: 'icon',
                href: 'https://github.com/tencent-connect/bot-docs/raw/main/docs/.vuepress/public/favicon-64px.png',
            },
        ],
    ],
    ...
    themeConfig: {
        ...
        editLink: {
            pattern:
                'https://github.com/tencent-connect/botpy/edit/master/docs/:path',
            text: '在 GitHub 上编辑此页',
        },
