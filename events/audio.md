...
- **参数模型**: [`Audio`](../models/other.md#audio-音频控制) — `__slots__` 包含: `channel_id`, `guild_id`, `audio_url`, `text`, `event_id`
...
- **参数模型**: [`Audio`](../models/other.md#audio-音频控制) — `__slots__` 同 `on_audio_start`
