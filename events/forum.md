...
| 事件方法 | 触发解析 | 参数模型 | 源码位置 |
|---------|---------|---------|---------|
| `on_forum_thread_create` | `parse_forum_thread_create` → `on_forum_thread_create` | [`Thread`](../models/forum.md) | [`connection.py` 第 246-248 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L246-L248) / [`forum.py` 第 70-152 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L70-L152) |
| `on_forum_thread_update` | `parse_forum_thread_update` → `on_forum_thread_update` | [`Thread`](../models/forum.md) | [`connection.py` 第 250-252 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L250-L252) / [`forum.py` 第 70-152 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L70-L152) |
| `on_forum_thread_delete` | `parse_forum_thread_delete` → `on_forum_thread_delete` | [`Thread`](../models/forum.md) | [`connection.py` 第 254-256 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L254-L256) / [`forum.py` 第 70-152 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L70-L152) |
...
| 事件方法 | 触发解析 | 参数模型 | 源码位置 |
|---------|---------|---------|---------|
| `on_open_forum_thread_create` | `parse_open_forum_thread_create` → `on_open_forum_thread_create` | [`OpenThread`](../models/forum.md) | [`connection.py` 第 281-283 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L281-L283) / [`forum.py` 第 155-172 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L155-L172) |
| `on_open_forum_thread_update` | `parse_open_forum_thread_update` → `on_open_forum_thread_update` | [`OpenThread`](../models/forum.md) | [`connection.py` 第 285-287 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L285-L287) / [`forum.py` 第 155-172 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L155-L172) |
| `on_open_forum_thread_delete` | `parse_open_forum_thread_delete` → `on_open_forum_thread_delete` | [`OpenThread`](../models/forum.md) | [`connection.py` 第 289-291 行](https://github.com/tencent-connect/botpy/tree/master/botpy/connection.py#L289-L291) / [`forum.py` 第 155-172 行](https://github.com/tencent-connect/botpy/tree/master/botpy/forum.py#L155-L172) |
